...
@Component({
  template: '<form #form1="ngForm" novalidate>' +
            ...
            '<input name="field2" #field2Model="ngModel" appValidateEqual="field1" [(ngModel)]="field2">' +
            '</form>'
})
class TestComponent {
...
describe('ValidateEqual', () => {
  ...
  it('should validate successfull', async (done) => {
    ...
    const field2Model = fixture.debugElement.query(By.css('input[name=field2]')).references['field2Model'];
